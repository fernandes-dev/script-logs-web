...
export default function SignupForm() {
  ...
  return <form name="signup-form" onSubmit={handleSubmit(handleSubmitLogin)}>
    <div>
    ...
    <div className="flex flex-col">
      ...
      <input {...register('name', {required: true})} className="border rounded-md h-10 px-2" id="name" type="text"
    ...
    <div>
      <button disabled={!isValid} type="submit"
              className={`bg-purple-800 hover:bg-purple-700 disabled:bg-purple-300 text-white rounded-md h-10 px-4 w-full`}>Register
      </button>
    </div>
  </form>
}